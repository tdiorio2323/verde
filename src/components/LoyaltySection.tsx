      ...
      <div className="relative container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10 max-w-6xl mx-auto mb-16">
          {benefits.map((benefit, index) => (
            <div key={index} className="group relative">
              {/* Outer Glow Layer */}
              <div
                className={`absolute -inset-0.5 bg-gradient-to-br ${benefit.gradient} rounded-[2rem] opacity-0 blur-xl group-hover:opacity-40 transition-all duration-700`}
              />
              ...
              <div className="relative liquid-glass rounded-[2rem] shadow-glass-xl hover:shadow-glow-sm transition-all duration-700 h-full border-2 border-white/[0.15] group-hover:border-white/[0.25] backdrop-blur-3xl overflow-hidden">
                {/* Top Gradient Accent */}
                <div
                  className={`absolute top-0 inset-x-0 h-1 bg-gradient-to-r ${benefit.gradient} opacity-70`}
                />
        ...
        <div className="text-center">
          <div className="relative inline-block">
            ...
            <div
              className="absolute inset-0 rounded-full blur-2xl opacity-40 group-hover:opacity-60 transition-smooth"
              style={{
                background:
