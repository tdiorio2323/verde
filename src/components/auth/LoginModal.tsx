          ...
          <form onSubmit={handleOtpSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                ...
                >
                  <InputOTPGroup>
                    <InputOTPSlot index={0} className="glass border-white/20 bg-white/5 text-white" />
                    <InputOTPSlot index={1} className="glass border-white/20 bg-white/5 text-white" />
                    <InputOTPSlot index={2} className="glass border-white/20 bg-white/5 text-white" />
                    <InputOTPSlot index={3} className="glass border-white/20 bg-white/5 text-white" />
                    <InputOTPSlot index={4} className="glass border-white/20 bg-white/5 text-white" />
                    <InputOTPSlot index={5} className="glass border-white/20 bg-white/5 text-white" />
                  </InputOTPGroup>
                </InputOTP>
              </div>
